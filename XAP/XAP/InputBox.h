...
#pragma region Windows Form Designer generated code
			...
			void InitializeComponent(void)
				...
				this->label1->Size = System::Drawing::Size(300, 13);
				...
				// button2
				// 
				this->button2->Location = System::Drawing::Point(172, 51);
				this->button2->Name = L"button2";
				this->button2->Size = System::Drawing::Size(75, 23);
				this->button2->TabIndex = 3;
				this->button2->Text = L"Cancel";
				this->button2->UseVisualStyleBackColor = true;
				this->button2->Click += gcnew System::EventHandler(this, &InputBox::button2_Click);
				// 
				// textBox1
				// 
...
#pragma endregion
			String ^response;
		public:
			::DialogResult ShowDialog(String ^message, String^ title){
				this->Text=title;
				label1->Text=message;
				return ShowDialog();
				}
